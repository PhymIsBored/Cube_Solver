public class CubeSolver {
    ...
    public CubeSolver(Cube pCube, CrossSolver pCS, NotationCompiler pNC, SolveF2L Psf) {
        cube = pCube;
        crossSolver = pCS;
        nc = pNC;
        sf = Psf;
    ...
    public String solveCube() {
        ...
        System.out.println(input);
        if (!solveOLL().equals("OLL not found")) {
            input = input + solveOLL(); // if this bit returns the error skip
            System.out.println(solveOLL()); // test
            nc.executeString(solveOLL());
        }
        if (!solvePLL().equals("PLL not found")) {
            input = input + solvePLL(); // if this bit returns the error, continue (orient and Top)
    ...
    public String orientTop() {
        ...
        for (int i = 0; i < ring.length(); i++) {
            if (cube.getColour(0, 4) == ring.charAt(0)) {
                counter = i;
                break;
            }
    ...
    public String solveF2Ls() { // this might not always work
        String input = null;
    ...
    public void changeF2L() {
        ...
        for (int i = start; i < stop; i++) {
            array[i] = ("F2L[" + "" + i + "][0] = " + '"' + d[i][0] + '"' + ';' + "\n");
            array[i] = array[i] + ("F2L[" + "" + i + "][1] = " + '"' + d[i][1] + '"' + ';');
        }
        for (int i = start; i < stop; i++) {
    ...
    public void fillOLL() { // outer;inner
        ...
        OLL[22][0] = "YXYXXXXXXXXX;XYXYYYYY";
        OLL[22][1] = "R2#D'#R#U2#R'#D#R#U2#R";
        OLL[23][0] = "YXXXXXXXYXXX;XYYYYYXY";
        OLL[23][1] = "r#U#R'#U'#r'#F#R#F'";
        OLL[24][0] = "XXXXXXYXXXXY;XYYYXYYY";
        OLL[24][1] = "F'#r#U#R'#U'#r'#F#R";
        OLL[25][0] = "XXXXXYXXYXXY;XYYYXYXY";
    ...
    public void fillF2L() { // 1
        ...
        F2L[88][1] = "y#U2#R2#U2#R'#U'#R#U'#R2";
        F2L[89][0] = "R:B1/g&R:C1/g&Y:B3/r&Y:C3/w&G:A1/r&";
        F2L[89][1] = "y2#U2#R2#U2#R'#U'#R#U'#R2";
        F2L[90][0] = "G:B1/o&G:C1/o&Y:C2/g&Y:C1/w&O:A1/g&";
        F2L[90][1] = "y'#U2#R2#U2#R'#U'#R#U'#R2";
        F2L[91][0] = "O:B1/b&O:C1/b&Y:B1/o&Y:A1/w&B:A1/o&";
        F2L[91][1] = "U2#R2#U2#R'#U'#R#U'#R2";
        F2L[92][0] = "B:C1/r&Y:A3/w&Y:B3/r&R:A1/b&R:B1/b&";
        F2L[92][1] = "y#F#U#R#U'#R'#F'#R#U'#R'";
        F2L[93][0] = "R:C1/g&Y:C3/w&Y:C2/g&G:A1/r&G:B1/r&";
        F2L[93][1] = "y2#F#U#R#U'#R'#F'#R#U'#R'";
        F2L[94][0] = "G:C1/o&Y:C1/w&Y:B1/o&O:A1/g&O:B1/g&";
        F2L[94][1] = "y'#F#U#R#U'#R'#F'#R#U'#R'";
        F2L[95][0] = "O:C1/b&Y:A1/w&Y:A2/b&B:A1/o&B:B1/o&";
        F2L[95][1] = "F#U#R#U'#R'#F'#R#U'#R'";
        F2L[96][0] = "B:C3/b&Y:B3/b&R:A3/r&R:B1/r&";
        F2L[96][1] = "y#R'#F'#R#U#R#U'#R'#F";
        F2L[97][0] = "R:C3/r&Y:C2/r&G:A3/g&G:B1/g&";
        F2L[97][1] = "y2#R'#F'#R#U#R#U'#R'#F";
        F2L[98][0] = "G:C3/g&Y:B1/g&O:A3/o&O:B1/o&";
        F2L[98][1] = "y'#R'#F'#R#U#R#U'#R'#F";
        F2L[99][0] = "O:C3/o&Y:A2/o&B:A3/b&B:B1/b&";
        F2L[99][1] = "R'#F'#R#U#R#U'#R'#F";
        F2L[100][0] = "B:B1/b&Y:A2/r&B:C3/b&R:A3/r&";
        F2L[100][1] = "y#U#R#U'#R'#U'#F'#U#F#";
        F2L[101][0] = "R:B1/r&Y:B3/g&R:C3/r&G:A3/g&";
        F2L[101][1] = "y2#U#R#U'#R'#U'#F'#U#F#";
        F2L[102][0] = "G:B1/g&Y:C2/o&G:C3/g&O:A3/o&";
        F2L[102][1] = "y'#U#R#U'#R'#U'#F'#U#F#";
        F2L[103][0] = "O:B1/o&Y:B1/b&O:C3/o&B:A3/b&";
        F2L[103][1] = "U#R#U'#R'#U'#F'#U#F#";
        F2L[104][0] = "B:C3/w&R:A3/b&Y:B3/b&R:B1/r&";
        F2L[104][1] = "y#R#U'#R'#U#R#U'#R'#";
        F2L[105][0] = "R:C3/w&G:A3/r&Y:C2/r&G:B1/g&";
        F2L[105][1] = "y2#R#U'#R'#U#R#U'#R'#";
        F2L[106][0] = "G:C3/w&O:A3/g&Y:B1/g&O:B1/o&";
        F2L[106][1] = "y'#R#U'#R'#U#R#U'#R'#";
        F2L[107][0] = "O:C3/w&B:A3/o&Y:A2/o&B:B1/b&";
        F2L[107][1] = "R#U'#R'#U#R#U'#R'#";
        F2L[108][0] = "B:B1/b&Y:A3/r&B:C3/r&R:A3/w&";
        F2L[108][1] = "y#R#U#R'#U'#F#R'#F'#R";
        F2L[109][0] = "R:B1/r&Y:C3/g&R:C3/g&G:A3/w&";
        F2L[109][1] = "y2#R#U#R'#U'#F#R'#F'#R";
        F2L[110][0] = "G:B1/g&Y:C1/o&G:C3/o&O:A3/w&";
        F2L[110][1] = "y'#R#U#R'#U'#F#R'#F'#R";
        F2L[111][0] = "O:B1/o&Y:A1/b&O:C3/b&B:A3/w&";
        F2L[111][1] = "R#U#R'#U'#F#R'#F'#R";
        F2L[112][0] = "B:B1/b&Y:A2/r&B:C3/w&R:A3/b&";
        F2L[112][1] = "y#y#L'#U'#L#U#L'#U'#L#";
        F2L[113][0] = "R:B1/r&Y:B3/g&R:C3/w&G:A3/r&";
        F2L[113][1] = "y2#y#L'#U'#L#U#L'#U'#L#";
        F2L[114][0] = "G:B1/g&Y:C2/o&G:C3/w&O:A3/g&";
        F2L[114][1] = "y'#y#L'#U'#L#U#L'#U'#L#";
        F2L[115][0] = "O:B1/o&Y:B1/b&O:C3/w&B:A3/o&";
        F2L[115][1] = "y#L'#U'#L#U#L'#U'#L#";
        F2L[116][0] = "B:C3/r&R:A3/w&R:B1/r&Y:B3/b&";
        F2L[116][1] = "y#F#R'#F'#R#F#R'#F'#R#";
        F2L[117][0] = "R:C3/g&G:A3/w&G:B1/g&Y:C2/r&";
        F2L[117][1] = "y2#F#R'#F'#R#F#R'#F'#R#";
        F2L[118][0] = "G:C3/o&O:A3/w&O:B1/o&Y:B1/g&";
        F2L[118][1] = "y'#F#R'#F'#R#F#R'#F'#R#";
        F2L[119][0] = "O:C3/b&B:A3/w&B:B1/b&Y:A2/o&";
        F2L[119][1] = "F#R'#F'#R#F#R'#F'#R#";
        F2L[120][0] = "B:C2/r&R:A2/b&B:C1/r&R:A1/b&Y:A3/w&";
        F2L[120][1] = "y#R#U'#R'#U2#F#R'#F'#R#";
        F2L[121][0] = "R:C2/g&G:A2/r&R:C1/g&G:A1/r&Y:C3/w&";
        F2L[121][1] = "y2#R#U'#R'#U2#F#R'#F'#R#";
        F2L[122][0] = "G:C2/o&O:A2/g&G:C1/o&O:A1/g&Y:C1/w&";
        F2L[122][1] = "y'#R#U'#R'#U2#F#R'#F'#R#";
        F2L[123][0] = "O:C2/b&B:A2/o&O:C1/b&B:A1/o&Y:A1/w&";
        F2L[123][1] = "R#U'#R'#U2#F#R'#F'#R#";
        F2L[124][0] = "B:C2/b&R:A2/r&B:C1/r&R:A1/b&Y:A3/w&";
        F2L[124][1] = "y#R2#U#R2#U#R2#U2#R2#";
        F2L[125][0] = "R:C2/r&G:A2/g&R:C1/g&G:A1/r&Y:C3/w&";
        F2L[125][1] = "y2#R2#U#R2#U#R2#U2#R2#";
        F2L[126][0] = "G:C2/g&O:A2/o&G:C1/o&O:A1/g&Y:C1/w&";
        F2L[126][1] = "y'#R2#U#R2#U#R2#U2#R2#";
        F2L[127][0] = "O:C2/o&B:A2/b&O:C1/b&B:A1/o&Y:A1/w&";
        F2L[127][1] = "R2#U#R2#U#R2#U2#R2#";
        F2L[128][0] = "B:C2/b&R:A2/r&B:C1/w&R:A1/r&Y:A3/b&";
        F2L[128][1] = "y#y#R'#D#R#U'#R'#D'#R";
        F2L[129][0] = "R:C2/r&G:A2/g&R:C1/w&G:A1/g&Y:C3/r&";
        F2L[129][1] = "y2#y#R'#D#R#U'#R'#D'#R";
        F2L[130][0] = "G:C2/g&O:A2/o&G:C1/w&O:A1/o&Y:C1/g&";
        F2L[130][1] = "y'#y#R'#D#R#U'#R'#D'#R";
        F2L[131][0] = "O:C2/o&B:A2/b&O:C1/w&B:A1/b&Y:A1/o&";
        F2L[131][1] = "y#R'#D#R#U'#R'#D'#R";
        F2L[132][0] = "B:C2/b&R:A2/r&B:C1/b&R:A1/w&Y:A3/r&";
        F2L[132][1] = "y#y'#U#R'#U#R#U2#R'#U#R";
        F2L[133][0] = "R:C2/r&G:A2/g&R:C1/r&G:A1/w&Y:C3/g&";
        F2L[133][1] = "y2#y'#U#R'#U#R#U2#R'#U#R";
        F2L[134][0] = "G:C2/g&O:A2/o&G:C1/g&O:A1/w&Y:C1/o&";
        F2L[134][1] = "y'#y'#U#R'#U#R#U2#R'#U#R";
        F2L[135][0] = "O:C2/o&B:A2/b&O:C1/o&B:A1/w&Y:A1/b&";
        F2L[135][1] = "y'#U#R'#U#R#U2#R'#U#R";
        F2L[136][0] = "B:C2/r&B:C1/w&R:A2/b&R:A1/r&Y:A3/b&";
        F2L[136][1] = "y#U'#R#U#R'#d#R'#U'#R";
        F2L[137][0] = "R:C2/g&R:C1/w&G:A2/r&G:A1/g&Y:C3/r&";
        F2L[137][1] = "y2#U'#R#U#R'#d#R'#U'#R";
        F2L[138][0] = "G:C2/o&G:C1/w&O:A2/g&O:A1/o&Y:C1/g&";
        F2L[138][1] = "y'#U'#R#U#R'#d#R'#U'#R";
        F2L[139][0] = "O:C2/b&O:C1/w&B:A2/o&B:A1/b&Y:A1/o&";
        F2L[139][1] = "U'#R#U#R'#d#R'#U'#R";
        F2L[140][0] = "B:C2/r&B:C1/b&R:A2/b&R:A1/w&Y:A3/r&";
        F2L[140][1] = "y#U2#F'#U'#F#U#R#U'#R'#";
        F2L[141][0] = "R:C2/g&R:C1/r&G:A2/r&G:A1/w&Y:C3/g&";
        F2L[141][1] = "y2#U2#F'#U'#F#U#R#U'#R'#";
        F2L[142][0] = "G:C2/o&G:C1/g&O:A2/g&O:A1/w&Y:C1/o&";
        F2L[142][1] = "y'#U2#F'#U'#F#U#R#U'#R'#";
        F2L[143][0] = "O:C2/b&O:C1/o&B:A2/o&B:A1/w&Y:A1/b&";
        F2L[143][1] = "U2#F'#U'#F#U#R#U'#R'#";
        F2L[144][0] = "B:C3/b&B:C2/r&R:A3/r&R:A2/b&";
        F2L[144][1] = "y#R#U2#R'#U#R#U2#R'#U#F'#U'#F#";
        F2L[145][0] = "R:C3/r&R:C2/g&G:A3/g&G:A2/r&";
        F2L[145][1] = "y2#R#U2#R'#U#R#U2#R'#U#F'#U'#F#";
        F2L[146][0] = "G:C3/g&G:C2/o&O:A3/o&O:A2/g&";
        F2L[146][1] = "y'#R#U2#R'#U#R#U2#R'#U#F'#U'#F#";
        F2L[147][0] = "O:C3/o&O:C2/b&B:A3/b&B:A2/o&";
        F2L[147][1] = "R#U2#R'#U#R#U2#R'#U#F'#U'#F#";
        F2L[148][0] = "B:C3/w&B:C2/b&R:A3/b&R:A2/r&";
        F2L[148][1] = "y#R2#U2#R'#U'#R#U'#R'#U2#R'#";
        F2L[149][0] = "R:C3/w&R:C2/r&G:A3/r&G:A2/g&";
        F2L[149][1] = "y2#R2#U2#R'#U'#R#U'#R'#U2#R'#";
        F2L[150][0] = "G:C3/w&G:C2/g&O:A3/g&O:A2/o&";
        F2L[150][1] = "y'#R2#U2#R'#U'#R#U'#R'#U2#R'#";
        F2L[151][0] = "O:C3/w&O:C2/o&B:A3/o&B:A2/b&";
        F2L[151][1] = "R2#U2#R'#U'#R#U'#R'#U2#R'#";
        F2L[152][0] = "B:C3/r&B:C2/b&R:A3/w&R:A2/r&";
        F2L[152][1] = "y#R#U2#R#U#R'#U#R#U2#R2#";
        F2L[153][0] = "R:C3/g&R:C2/r&G:A3/w&G:A2/g&";
        F2L[153][1] = "y2#R#U2#R#U#R'#U#R#U2#R2#";
        F2L[154][0] = "G:C3/o&G:C2/g&O:A3/w&O:A2/o&";
        F2L[154][1] = "y'#R#U2#R#U#R'#U#R#U2#R2#";
        F2L[155][0] = "O:C3/b&O:C2/o&B:A3/w&B:A2/b&";
        F2L[155][1] = "R#U2#R#U#R'#U#R#U2#R2#";
        F2L[156][0] = "B:C3/w&B:C2/r&R:A3/b&R:A2/b&";
        F2L[156][1] = "y#F'#L'#U2#L#F#R#U#R'#";
        F2L[157][0] = "R:C3/w&R:C2/g&G:A3/r&G:A2/r&";
        F2L[157][1] = "y2#F'#L'#U2#L#F#R#U#R'#";
        F2L[158][0] = "G:C3/w&G:C2/o&O:A3/g&O:A2/g&";
        F2L[158][1] = "y'#F'#L'#U2#L#F#R#U#R'#";
        F2L[159][0] = "O:C3/w&O:C2/b&B:A3/o&B:A2/o&";
        F2L[159][1] = "F'#L'#U2#L#F#R#U#R'#";
        F2L[160][0] = "B:C3/r&B:C2/r&R:A3/w&R:A2/b&";
        F2L[160][1] = "y#R#U'#R'#F'#L'#U2#L#F#";
        F2L[161][0] = "R:C3/g&R:C2/g&G:A3/w&G:A2/r&";
        F2L[161][1] = "y2#R#U'#R'#F'#L'#U2#L#F#";
        F2L[162][0] = "G:C3/o&G:C2/o&O:A3/w&O:A2/g&";
        F2L[162][1] = "y'#R#U'#R'#F'#L'#U2#L#F#";
        F2L[163][0] = "O:C3/b&O:C2/b&B:A3/w&B:A2/o&";
